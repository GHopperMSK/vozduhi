...
class ControllerExtensionTltBlogTltBlogSettings extends Controller {
	...
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if ($this->request->post['tltblog_status']) {
                ...
                $request_post['tltblog_tltblog_status'] = '1';
                $request_post['tltblog_tlttag_status'] = '1';
            } else {
                $request_post['tltblog_tltblog_settings_status'] = '0';
                $request_post['tltblog_tltblog_status'] = '0';
                $request_post['tltblog_tlttag_status'] = '0';
            }
	...
	public function install()
    {
        ...
        if (!$this->config->has('tltblog_db_version')) {
